...
namespace hrms
{
    public partial class tickets : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static string populatetickets()
        {
            var data = "";
            ...
            try
            {
                ...
                using (var conn = new MySqlConnection(connectionString))
                {
                    ...
                    string announncement_Query = $@"SELECT t.ticket_id, e.emp_id, CONCAT(e.first_name, "" "", e.last_name) AS emp_name, t.title, t.ticket_description, t.attachments, 
